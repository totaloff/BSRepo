...
if (!class_exists('PhoenixTeam_Redux_Framework_Config')) {

    class PhoenixTeam_Redux_Framework_Config {
        ...
        public function setArguments ()
        {
            ...
            $this->args = array(
                ...
                'display_version'   => "v." .$theme->get('Version'). ', <span>by <a target="_blank" href="//themeforest.net/user/PhoenixTeam">'. THEME_TEAM .'</a></span>',      // Version that appears at the top of your panel
                'menu_type'         => 'menu',                      //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
                'allow_sub_menu'    => false,                        // Show the sections below the admin menu item or not
                'menu_title'        => THEME_NAME . ' ' . __('Options', THEME_SLUG),
                'page_title'        => THEME_NAME . ' ' . __('Options', THEME_SLUG),
                ...
                'page_slug'         => THEME_SLUG . '_options',     // Page slug used to denote the panel
                ...
                'footer_credit'     => '&copy; ' . THEME_TEAM . ', ' . date('Y'),
            );

            $this->args['share_icons'][] = array(
                'url'   => '//twitter.com/Ph0enixTeam',
                'title' => __('Follow us on Twitter', THEME_SLUG),
                'icon'  => 'el-icon-twitter'
            );
            $this->args['share_icons'][] = array(
                'url'   => '//themeforest.net/user/PhoenixTeam',
                'title' => __('Buy our items on Envato', THEME_SLUG),
        ...
        public function setHelpTabs ()
        {
            ...
            $this->args['help_tabs'][] = array(
                'id'        => 'online-docs',
                'title'     => __('Theme Online Documentation', THEME_SLUG),
                'content'   => __('<p>Please see it online at <a target="_blank" href="//phoenix-themes.com/documentation/primary/">http://phoenix-themes.com</a>.</p>', THEME_SLUG)
            );
            $this->args['help_tabs'][] = array(
                'id'        => 'online-knowledge',
                'title'     => __('Our Products Knowledge Base', THEME_SLUG),
                'content'   => '<p>It will bee ready soon. Apologise.</p>'
            );
            $this->args['help_tabs'][] = array(
                'id'        => 'online-support',
                'title'     => __('Get Online Support', THEME_SLUG),
                'content'   => '<p>Need help? Feel free to ask us at our <a target="_blank" href="//themeforest.net/user/PhoenixTeam">Themeforest Profile</a>. We are friendly and we are always help our customers.</p>'
            );

            // Set the help sidebar
            $this->args['help_sidebar'] = '<br /><a target="_blank" href="//themeforest.net/"><img style="width: 100%;" src="'.THEME_URI.'/screenshot.png" alt="Theme-logo.png" /></a>';
        }
        ...
        public function setSections ()
        {
            ...
            require_once $this->path . '/settings/import.php';
        }

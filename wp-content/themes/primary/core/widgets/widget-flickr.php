            ...
            <script>
                jQuery(function($) {
                    ...
                    var id = "<?php echo esc_js($id); ?>",
                        ...
                        flickApi = "//api.flickr.com/services/feeds/photos_public.gne?jsoncallback=?";
                            ...
                            $.each(data.items,
                                ...
                                function(i,item) {
                                    ...
                                    if(i < limit){
                                        ...
                                        $("<img/>", {'data-no-retina': 1}).attr("src", item.media.m.replace('_m', '_s')).appendTo("#flickr-<?php echo $counter; ?>").wrap("<a href='" + item.media.m.replace('_m', '_z') + "' name='"+ item.link + "' title='" +  item.title +"'></a>");
                                    }
                                }
                            );
                        }

...
class PhoenixTeam_eCommerce {
    ...
    public function __construct ()
    {
        ...
        if (isset($this->reduxData['show_menu_cart']) && $this->reduxData['show_menu_cart']) {
            // Add Menu Cart
            require_once THEME_DIR . '/core/deps/menu-cart/wp-menu-cart.php';
        }
    }
    ...
    {
        $data = $this->reduxData;
        $qty = $data['related_goods_qty'] ? $data['related_goods_qty'] : 4;
        $cols = $data['related_goods_cols'] ? $data['related_goods_cols'] : 4;
    ...
    {
        $data = $this->reduxData;
        $qty = $data['goods_grid_qty'] ? $data['goods_grid_qty'] : 4;

 ...
 *
 * PhoenixTeam custom  !!! EXclude el_id & full_width -- must be rewrite
 * @var $id
 * @var row_type
 *
 * @var $atts
...
$css_class = preg_replace('/\s+/', ' ', apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, implode(' ', array_filter( $css_classes)), $base, $atts ));
$wrapper_attributes[] = 'class="' . esc_attr(trim($css_class)) . '"';

if ($id)
    $id = 'id="'. esc_attr($id) .'"';

$output .= '<div '. $id . implode(' ', $wrapper_attributes) . '>';
...
if ($row_type === 'fullwidth')
    $output .= '<div class="container-in-container-inner">';

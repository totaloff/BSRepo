<?php
    ...
    $PHTquote_text = rwmb_meta( THEME_SLUG . "_postformat_quote_text" );
    $PHTquote_author = rwmb_meta( THEME_SLUG . "_postformat_quote_author" );
?>
...
<div class="cl-blog-naz">
    ...
    <div class="cl-blog-name">
        ...
        <?php if ($PHTquote_text) : ?>
            <blockquote>
                <p><?php echo wp_kses_post($PHTquote_text); ?></p>
            </blockquote>
            <?php if ($PHTquote_author) : ?>
                <div class="post-format-quote-author">&mdash; <?php echo esc_html($PHTquote_author); ?></div>
            <?php endif; ?>
        <?php endif; ?>
    </div >
